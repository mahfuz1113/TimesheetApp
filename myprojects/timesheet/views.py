...
#     queryset = TimesheetDetail.objects.filter(timesheet__weekenddate__weekenddate='2017-01-04')
#
...
class TimesheetListView(ListView):
    ...
    def get_queryset(self,**kwargs):
        return Timesheet.objects.filter(weekenddate__weekenddate=self.kwargs.get('weekenddate', '2017-01-04'))\
                                .select_related('employee')\
                                .select_related('weekenddate')\
                                .order_by('employee__username','weekenddate')
